...
export default function Login(props) {
  const [loginData] = useState([
    {
      user: 'kiranmonangi1998@gmail.com',
      password: '123456',
    },
    {
      user: 'kiranm@ezeu.in',
    ...
    {
      user: 'kmonangi@miacleeducationalsociety.com',
      password: '123456',
    },
    {
  ...
  const check = () => {
    const value = loginData.find(
      ((index) => (index.user === email) && (index.password === password)),
    );
        ...
        <View style={styles.centerizedView}>
          <View style={styles.authBox}>
            <View style={styles.logoBox}>
              <FontAwesome5 name="bars" size={54} color="#fff" />
            </View>
